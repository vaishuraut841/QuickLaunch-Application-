...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        primaryStage.getIcons().add(new Image(getClass().getResourceAsStream("Quick.png")));
        ...
        new Thread(() -> {
            try {
                ...
                for (String command : option.getCommands()) {
                    ...
                    if (isWindows()) {
                        // For Windows, wrap the command in "cmd /c" to ensure it's executed properly
                        cmdParts = new String[]{"cmd.exe", "/c", command.trim()};
                    } else {
